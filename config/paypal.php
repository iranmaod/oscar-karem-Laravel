...
return array(
    ...
    'subscription' => [
        'product' => [
            'name' => env('PAYPAL_SUBSCRIPTION_PRODUCT_NAME', 'Subscription Plan'),
            'type' => env('PAYPAL_SUBSCRIPTION_PRODUCT_TYPE', 'SERVICE'),
            'description' => env('PAYPAL_SUBSCRIPTION_PRODUCT_DESCRIPTION', 'A product for paypal subscription'),
        ]
    ]
);
