...
Zahlung nicht erfolgreich für Order ID # {{$order->id}}

<p>Hallo,</p>
<p>
    Die Zahlung in Höhe von EUR {{$transaction->amount}} war nicht erfolgreich. Bitte kontaktiere uns <br>
    unverzüglich zu diesem Thema.
